...
[BASE] = LAYOUT( /* Base */
  ...
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_END,  KC_DEL,  KC_PGDN, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_QUOT,
  MO(2),   KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,  KC_BSPC,   K_SPCFN,        KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,MO(2)
    ),
[NUMB] = LAYOUT(
...
[CURS] = LAYOUT(
  _______, _______, _______, _______, _______, _______, _______, KC_PWR, _______, _______, _______, _______, _______, _______, _______,
  ...
  _______, UNDO,    CUT,     COPY,    PASTE,   _______, _______, _______, _______, _______, K_LSTRT, _______, K_LEND,  _______, KC_WAKE,
